 ...
 * (2) {@link zatribune.spring.jasperreports.db.entities.ReportTable} a collection data source provided to
 *      the famously used {@link net.sf.jasperreports.engine.data.JRBeanCollectionDataSource}.
 * (3) {@link zatribune.spring.jasperreports.db.entities.ReportTableColumn} fields within each list in (2).
